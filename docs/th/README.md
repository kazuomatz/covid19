...
และ เว็บไซต์ (https://stopcovid19.city.shizuoka.lg.jp/) จะได้รับการอัพเดท
...
| Production | master | https://stopcovid19.city.shizuoka.lg.jp/ | ห้ามสร้าง pull request ยกเว้นจาก admin เอง |

#### branch ที่ถูกใช้โดยระบบ
| จุดประสงค์ | branch | URL | หมายเหตุ |
| ---- | -------- | ---- | ---- |
| Production site HTML | production | https://stopcovid19.city.shizuoka.lg.jp/ | HTML สำหรับ production |

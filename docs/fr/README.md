...
et le site production (https://stopcovid19.city.shizuoka.lg.jp/) est aussi mis-à-jour.
...
Production | master | https://stopcovid19.city.shizuoka.lg.jp/ | Pull request d'utilisateurs non-admin sont defendues. |

#### Branches utilisees par le systeme

| But | Branche | URL | Notes |
| ---- | -------- | ---- | ---- |
| Production site HTML | production | https://stopcovid19.city.shizuoka.lg.jp/ | Place ou les pages HTML statiques sont stockees. |
